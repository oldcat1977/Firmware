...
float Tracker::fast_sqrt(uint16_t val, bool fallback_to_infinity)
{
	const float values[] = {
...
bool Tracker::push_delta(size_t &index, ipos_t delta, bool jump, ssize_t max_space, delta_item_t *buffer)
{
